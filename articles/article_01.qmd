...
<p id = "result">After you select your file, the total point value will appear here!<p>
```
The relevant JavaScript file is [here](/js/Day2.js).  Use the Web Inspector tool on your browser to identify the elements on the html page that are accessed by the code.
