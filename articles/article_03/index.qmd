...
Our base ten system operates as follows (we will use $\frac{1}{27}$ for this example):

$$
\frac{1}{27}=0. \overline{037} =0\frac{1}{10}+3\frac{1}{100}+7\frac{1}{1000}+0\frac{1}{10000}+3\frac{1}{100000}+7\frac{1}{1000000}+...
$$
